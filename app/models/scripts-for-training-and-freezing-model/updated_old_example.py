...
MODEL_NAME = 'inference-graph-dandelions-and-clovers-relabeled'
...
PATH_TO_LABELS = os.path.join('dandelions-and-clovers-relabeled', 'object-detection.pbtxt')
...
PATH_TO_TEST_IMAGES_DIR = 'dandelions-and-clovers-test/allcategories/' #'train2/dandelion/test/'
TEST_IMAGE_PATHS = [ os.path.join(PATH_TO_TEST_IMAGES_DIR, '{}.png'.format(i)) for i in range(1, 57) ] 
    ...
    with tf.compat.v1.Session(graph=detection_graph) as sess:
        ...
        for image_path in TEST_IMAGE_PATHS:
            try:
                ...
                plt.savefig("all_weeds_output/detection_output-{}.png".format(i))
                # plt.close()
                i = i+1
                #close()
                print(i)
